...
- 用途：解剖结构分件、内部件齐全的"主角"器官。2026-08-18 起以下结构已换成 HRA 版：
  ...
  **肾**（皮质/锥体/肾门）、**膀胱**（膀胱三角）、**前列腺**（外周带/移行带/中央带）、
  **肝**（尾状叶/方叶/肝门/镰状韧带）、**脊髓**（颈/胸/腰/骶髓）、
  **小肠**（十二指肠/空肠/回肠）、**大肠**（盲肠/升/横/降/乙状结肠/直肠）、
  **阑尾**、**输尿管**（肾盂/肾盏）、**胸腺**。
  另有四条 BodyParts3D 没有的新结构来自 HRA：**主支气管**、**精囊**、
  **眼球**（角膜/虹膜/晶状体/视网膜）、**腭扁桃体**、**支气管树**（含支气管软骨）。
  其余器官仍为 BodyParts3D
- **大肠那一件（`3d-sbu-m-large-intestine.glb`）由 Kristen Browne 与 Heidi Schlehlein 共同署名**，
  许可证同为 CC BY 4.0（见该 digital object 的 metadata.json）
